####Script to create figure 2 for mortality SLR
####Combination of paper accumulation, taxonomic group breakdown and map
####Liam Langley
...
ggsave(plot = acc_plot, filename = "mortality_SLR_paper_acc_plot.tiff",
       device = device,
...
ggsave(plot = paper_map, filename = "mortality_SLR_paper_map.tiff",
       device = device,
       path = out_path ,units = units, width = 200, height = 175, dpi = dpi,   
)
...
ggsave(plot = tg_plot, filename = "mortality_SLR_tg_barplot.tiff",
       device = device,
       path = out_path ,units = units, width = 200, height = 175, dpi = dpi,   
)
